...
let romance = [
  ...
  },
  {
    ...
    'released': '2021',
    'blurb': 'This movie takes an interesting approach to the classic “She’s All That” and finds '
      + 'a very creative way to… ruin it. Grab some friends and some popcorn and get ready to '
      + 'laugh. Make sure you have your remote next to you so you can pause every five minutes '
      + 'to make fun of what just happened. My friends and I had a great time with this one. '
      + '10/10 recommend.',
...
let action = [
  {
    ...
    'synopsis': 'Synopsis: The films follow the missions of the IMF’s (Impossible Missions Force) '
    + 'main field team under the leadership of Ethan Hunt to stop an enemy force all the while '
    + 'preventing an impending global disaster.',
